#!/usr/bin/env python3
"""Create a deterministic Phase 7 sentiment report from JSON."""
...
from research.sentiment import build_sentiment_report
...
def main() -> int:
    ...
    try:
        ...
        report = build_sentiment_report(document)
        ...
        print(f"sentiment report error: {exc}", file=sys.stderr)
        return 2
